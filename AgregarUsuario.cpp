...
void AgregarUsuario::run() {
    ...
    sf::Text textoUsuario("Usuario:", font, 20); // Texto para el campo de usuario
    textoUsuario.setPosition(50, 20); // Posición del texto
    textoUsuario.setFillColor(sf::Color::Black);
    
    sf::Text textoContrasena("Contrasena:", font, 20); // Texto para el campo de contraseña
    textoContrasena.setPosition(50, 70); // Posición del texto
    ...
    while (addWindow.isOpen()) {
        ...
        addWindow.draw(textoUsuario); // Dibuja el texto "Usuario:"
        addWindow.draw(textoContrasena); // Dibuja el texto "Contrasena:"
